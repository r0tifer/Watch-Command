<#
    Pester 5 tests for CommandWatch module. Run via Invoke-Pester -Path '.\CommandWatch\tests'.
#>
...
Describe 'Invoke-CommandWatch public surface' {
    ...
    It 'exports expected aliases' {
        ...
        (Get-Alias 'watch' -ErrorAction Stop).Definition | Should -Be 'Invoke-CommandWatch'
    }
